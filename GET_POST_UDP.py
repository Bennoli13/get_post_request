...
var=""
host="ip-sflow-rt"
url = "http://"+host+"/metric/10.0.0.11/udp_minimal/json"
print(url)
...
def post_req(new_value):
    try:
        ...
        table_name = "udp_database"
        sql_query = "INSERT INTO "+ table_name + "(ipsource, ipdestination, udpsourceport, udpdestinationport, udpbytes, bytes, lastUpdate) VALUES (" + new_value +")"
